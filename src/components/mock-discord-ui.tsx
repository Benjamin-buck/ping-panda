...
const MockDicsordUi = ({ children }: PropsWithChildren) => {
  return (
    <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
      ...
      <div className="hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center">
        ...
        {[...Array(5)].map((_, i) => (
          <div
            key={i}
            className="size-12 bg-discord-background rounded-3xl flex items-center justify-center hover:rounded-xl mb-3 transition-all duration-200 hover:bg-discord-brand-color cursor-not-allowed"
          >
        ...
        <div className="group mt-auto size-12 bg-discord-background rounded-3xl flex items-center justify-center hover:rounded-xl mb-3 transition-all duration-200 hover:bg-[#3ba55c] cursor-not-allowed">
      ...
      <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
        <div className="px-4 h-16 border-b border-[#202225] items-center flex shadow-sm">
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          <div className="px-2 mb-4">
            <div className="flex items-center text-sm px-2 py-1.5 rounded hover:bg-[#393c43] text-[#dcddde] cursor-not-allowed">
              <UserCircle className="mr-4 size-8 text-[#b0bbbe]" />
              <span className="font-medium text-sm">Friends</span>
            </div>
            <div className="flex items-center text-sm px-2 py-1.5 rounded hover:bg-[#393c43] text-[#dcddde] cursor-not-allowed">
              <Inbox className="mr-4 size-8 text-[#b0bbbe]" />
          ...
          <div className="flex items-center">
            <div className="relative">
              <Image
                ...
                className="object-cover rounded-full mr-3"
              />
              <div className="absolute bottom-0 right-2 size-4 bg-green-500 rounded-full border-2 border-[#36393f]" />
            </div>
